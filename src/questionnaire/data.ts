...
// Seventh version of Phase 1 questionnaire
export const sopanswQuestionnaireComprehensive7: Questionnaire = {
  id: "sopa-nsw-eligibility",
  title: "SOPA NSW Contract Eligibility Questionnaire (Comprehensive7)",
  description:
    "This questionnaire helps determine eligibility under the Security of Payment Act (SOPA) in New South Wales (NSW) and assigns the applicant to an appropriate role.",
  questions: [
    // Section 1: Tell us about yourself and location
    ...
    // Payment Claim Information (Positioned after role determination)
    {
      id: "Q8a",
      ...
      type: "boolean",
      options: ["Yes", "No"],
      helpText: "A payment claim is the formal document you send to request payment under SOPA NSW. If you've already sent one, you can proceed to Phase 2 for detailed validation. If not, you'll need to file and serve your payment claim first."
    },
    {
      id: "Q8b",
...
// Enhanced Phase 2 questionnaire with questions specific types 
export const sopanswPhase2QuestionnaireContractualAndDateSpecific2: Questionnaire = {
  id: "sopa-nsw-phase-2-enhanced",
  title: "Phase 2 - Payment Claim Validation (Enhanced)",
  description: "This questionnaire helps validate your payment claim under SOPA NSW and ensures all legal requirements are met before proceeding with your case.",
  questions: [
...
export const sopanswPhase2QuestionnaireContractualAndDateSpecific4: Questionnaire = {
  id: "sopa-nsw-phase-2-enhanced",
  title: "Phase 2 - Payment Claim Validation (Enhanced)",
  description: "This questionnaire helps validate your payment claim under SOPA NSW and ensures all legal requirements are met before proceeding with your case.",
  questions: [
    // Business Information (at the start, before role selection)
    {
      id: "BUSINESS_NAME",
      text: "Your name or business name",
      key: "contract_party_name",
    ...
    },
    {
      ...
      type: "text",
      options: null,
      helpText: "Your Australian Business Number (ABN) or Australian Company Number (ACN) helps us verify your business registration and ensure accurate record-keeping. This is optional but recommended."
    },
